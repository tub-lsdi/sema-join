...
from sema_join.corpus import normalize_value, set_normalization_strategy, NormalizationStrategy
...
def test_rsjp_join(left_values: list[str], right_values: list[tuple[str, str]], description: str):
