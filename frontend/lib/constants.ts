...
export const ERROR_MESSAGES = {
  ...
  AI_OLLAMA_NOT_RUNNING: 'Ollama is not running. Please start it with: ollama serve',
  AI_MODEL_NOT_FOUND: 'AI model not found. Please install it with: ollama pull mistral',
} as const;
